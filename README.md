...
Repo này host **bản cài đặt mới nhất** và **kênh cập nhật tự động** cho phần mềm AnswerSheetGrader.

---

## Tải xuống bản mới nhất

1. Vào trang [**Releases**](https://github.com/viettien117/AnswerSheetGrader-updates/releases/latest)
2. Trong mục **Assets**, tải file `AnswerSheetGrader-x.y.z-x64.msi` (cuối trang)
3. Double-click file `.msi` vừa tải → đi qua wizard cài đặt
4. Sau khi cài xong, mở phần mềm từ **Start Menu** → tìm "Answer Sheet Grader"
...
Xem chi tiết changelog của từng phiên bản tại trang [Releases](https://github.com/viettien117/AnswerSheetGrader-updates/releases).
